...
1. Последовательная отработка функционирования отдельных устройств АСУ ТП
2. Отработка измерительных каналов АСУ ТП
3. Расчётно-экспериментальная проверка алгоритмов сбора, обработки информации, выработки и реализации управляющих воздействий
4. В результате проводят комплексные испытания системы с набором статистических данных и оценкой точности измерительных каналов
5. Уточнение предварительных расчётов технико-экономической эффективности. 

### 4. Решение организационных вопросов с учётом социальных аспектов внедрения АСУ ТП.
...
![-c800](media/mepuJHLWRuiccxQBlch6Hg_thumb_3bbf.jpg)
...
![-c400](media/U%2527bMJeSz+vVFIamsqkUw_thumb_3bbd.jpg)
