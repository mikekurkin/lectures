...
Определить первоначальную, остаточную и восстановительную стоимость металлорежущего станка при его моральном износе \\(30 \%\\), если известны следующие данные: цена станка, использование которого начато 4 года назад, составляет 150000 руб., доставка — 10000 руб., монтаж — 30000 руб. Норма амортизации \\(14,2 \%\\) в год, амортизация начисляется линейным способом. Затраты на капитальный ремонт в период эксплуатации составили 20000 руб. Была также произведена модернизация станка стоимостью 35000 руб. 

\\[С_{пер} = 150000 + 10000 + 30000 = 190000 \, руб.\\]
\\[С_{вос} = 190000 \cdot 70 \% + 20000 + 35000 = 188000 \, руб.\\]

\\[С_{ост} = С_{пер} - A_м\\]

\\[S_{ам \, год} = 190000 \cdot 14,2 \% = 26980 \, руб.\\]
\\[A_м = 4 \cdot 26980 = 107920 \, руб.\\]
\\[С_{ост} = 190000 - 107920 = 82080 \, руб.\\]

***
*Задача:*

Определить полную первоначальную стоимость ОПФ предприятия, если известно, что средняя норма амортизационных отчислений составляет \\(11 \%\\), а сумма ежегодных амортизационных отчислений равна 894000 руб.

\\[S_{ам \, год} = 894000 = С_{ОПФ} \cdot 11 \% =\\]
\\[С_{ОПФ} = \frac{894000}{0,11} = 8127273 \, руб.\\]

***
*Задача:*

В начале года предприятие имело производственное оборудование на сумму 34000000 руб. В течении года вводилось новое оборудование. В апреле — на 5500000 руб., в ноябре — на 4200000 руб., в июне выбыло оборудование на сумму 7700000 руб. Определить среднегодовую стоимость основных фондов и годовую сумму амортизационных отчислений, если известно, что средняя норма амортизации оборудования составляет \\(11,5 \%\\). 

\\[С_{ср.год.} = С_{н.г.} + С_{вв.} \frac{n_1}{12} - С_{выб.} \frac{n_2}{12}\\]
\\[С_{ср.год.} = 34000000 + 5500000 \cdot \frac{8}{12} + 4200000 \cdot \frac{1}{12} - 7700000 \cdot \frac{6}{12} = 38012816 \, руб.\\]
\\[S_{ам \, год} = С_{ср.год.} \cdot 11,5 \% = 4371474 \, руб.\\]
